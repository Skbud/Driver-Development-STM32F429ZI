 ...
 * @Parameter[pUSARTx]			-Holds base address of the USART Peripheral
 * @Parameter[BaudRate]			-Baud Rate for communication
 * @Parameter[]
 * @return								-None
 * @special note:						-None
 */
 ...
 * *//***********************************************************************************************
 * @Function:							-  USART_Init
 * @Description:						-It initilize the USART Peripheral
 * @Parameter[pUSARTHandle]	-Pointer to handle Structure
 * @Parameter[]						-None
 * @Parameter[]
 * @return								-None
 * @special note:						-None
 ...
 * @Description:						-Enables Clock for USART Peripheral
 * @Parameter[pUSARTx]		-USART Peripheral Address
 * @Parameter[EnorDi]			-Enable or Disable
 * @Parameter[]
 * @return								-None
 * @special note:						-None
 */
 ...
 * @Description:							-Send data in poling mode
 * @Parameter[*pUSARTHandle]-Pointer to handle structure
 * @Parameter[pTxBuffer]			-Tx buffer
 ...
 * @Description:							-Receive data in poling mode
 * @Parameter[*pUSARTHandle]-Pointer to handle structure
 * @Parameter[pTxBuffer]			-Rx buffer
 * @Parameter[Len]					-Length of data
 * @return									-None
 * @special note:							-None
 */
...
/*
 * *//***********************************************************************************************
 * @Function:								-  USART_SendDataIT
 * @Description:							-Send data in interrupt  mode
 * @Parameter[*pUSARTHandle]-Pointer to handle structure
 * @Parameter[pTxBuffer]			-Tx buffer
 * @Parameter[Len]					-Length of data
 * @return									-None
...
/*
 * *//***********************************************************************************************
 * @Function:								-  USART_ReceiveDataIT
 * @Description:							-Receive  data in interrupt  mode
 * @Parameter[*pUSARTHandle]-Pointer to handle structure
 * @Parameter[pTxBuffer]			-Tx buffer
 * @Parameter[Len]					-Length of data
 * @return									-None
 ...
 * @Description:							-Clears Flag status
 * @Parameter[*pUSARTx]			-Peripheral address
 * @Parameter[StatusFlagName]-Flag name
 * @Parameter[]							-None
 * @return									-None
 * @special note:							- Applicable to only USART_CTS_FLAG , USART_LBD_FLAG
...
/*
 * *//***********************************************************************************************
 * @Function:								-  USART_IRQInterruptConfig
 * @Description:							-Enables Interrupt
 * @Parameter[IRQNumber]		-IRQ Number
 * @Parameter[EnorDi]-				-Enable or Disable Interrupt
 * @Parameter[]							-None
 * @return									-None
 * @special note:							-None
 */
 ...
 * @Description:							-Sets priority for given IRQ number
 * @Parameter[IRQNumber]		-IRQ Number
 * @Parameter[IRQPriority]-		-Priority Value
 * @Parameter[]							-None
 * @return									-None
 * @special note:							-None
 */
